...
update_kernel(){
    ...
    wget https://elrepo.org/linux/kernel/el7/x86_64/RPMS/kernel-ml-devel-4.19.0-1.el7.elrepo.x86_64.rpm
    rpm -ivh kernel-ml-devel-4.19.0-1.el7.elrepo.x86_64.rpm
